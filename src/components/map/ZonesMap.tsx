...
export default function ZonesMap({
  zones, selectedZoneId, itineraire = [], onZoneClick,
}: ZonesMapProps) {
  ...
  useEffect(() => {
    ...
    const initMap = async () => {
      ...
      map = new maplibre.Map({
        ...
        style: {
          version: 8,
          // glyphs nécessaire pour text-field
      ...
      map.on('load', () => {
        ...
        // Labels : utiliser 'Open Sans Regular' disponible via demotiles
        map.addLayer({
  ...
  useEffect(() => {
    ...
    // Ajuster la vue sur les polygones
